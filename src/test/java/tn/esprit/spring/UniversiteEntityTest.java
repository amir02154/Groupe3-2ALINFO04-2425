...
class UniversiteEntityTest {
    ...
    void testUniversiteToString() {
        ...
        assertTrue(toString.contains("ESPRIT"));
        assertTrue(toString.contains("Tunis"));
    }
